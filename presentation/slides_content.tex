...
\small
\begin{tabular}{>{\raggedright\arraybackslash}p{1.1cm} >{\raggedright\arraybackslash}p{4.6cm} >{\raggedright\arraybackslash}p{3.4cm}}
\toprule
\textbf{Run} & \textbf{Setting} & \textbf{Purpose} \\
\midrule
R1 & hidden=64, 2 layers, 40 ep, no norm / dropout / clipping & raw baseline \\
R2 & + z-score + dropout(0.2) & normalization + regularization \\
R3 & R2 + gradient clipping & training stability \\
\bottomrule
\end{tabular}
\vspace{0.4em}
\small
